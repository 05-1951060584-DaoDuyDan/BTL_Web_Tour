                                            ...
                                            <div class="card">
                                                ...
                                                ?>
                                                    <div class="card-body">
                                                        ...
                                                        <a href="tourmanager.php?tourcode=<?php echo $tour_code ?>" class="card-link text-decoration-none">Chỉnh sửa Tour</a><br>
                                                    </div>
                                                <?php
                                                }   
                                                else{
                                                ?>
                                                    <div class="card-body">
                                                        <a href="tourmanager.php?tourcode=<?php echo $tour_code ?>" class="card-link text-decoration-none">Thêm thông tin Tour</a><br>
                                                    </div>
                                                <?php
                                                }
                                                ?>
