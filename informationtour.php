...
?>
                        ...
                        <div>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade tour_information" id="nav-contact2" role="tabpanel" aria-labelledby="nav-contact2-tab">
                                    <?php
                                    $manager = $ps->getALLElements("id_touroperator", $rowinfotour['id_touroperator'] ,"tb_touroperator");
                                    /**/
                                    ?>
                                    <h3 class="text-primary"><?php echo $manager['nametouroperator'] ?></h3>
                                    <p>Số điện thoại: <?php echo $manager['phonenumber'] ?></p>
    ...
    ?>
        <main style="margin-top: 120px; margin-bottom: 200px;">
            <div class="container mb-5">
                <div class="row">
                    <div class="col-md-8 bg-white ms-auto me-auto" style="margin-left:12px">
                        <h4 class="text-primary text-center">Tour này hiện tại đang bị khóa hoặc không còn phục vụ quý khách vui lòng chọn Tour khác!</h4>
                    </div>
                </div>
            </div>
        </main>
