                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="row bg-white" style="margin-left: 1px">
                            <form class="row g-3 needs-validation" enctype="multipart/form-data" action="process-updateInforUser.php" method="POST" novalidate>
                                <div class="col-md-12">
                                    <!--   -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" name="emailUpdate" value="<?php echo $row['email'] ?>" style="display: none;">
                                <div class="col-md-12">
