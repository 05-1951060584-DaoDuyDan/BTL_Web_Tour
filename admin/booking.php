    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-5 mt-3 mb-4">
                <select class="form-select" id="nametourselected" aria-label="Default select example">
                    <option selected value="Chọn Tour">Chọn Tour</option>
                    <?php
                    $sql = "SELECT * FROM tb_tour";
                    $res = mysqli_query($conn, $sql);
                    while($rows = mysqli_fetch_assoc($res)){
                    ?>
                        <option value="<?php echo $rows['tour_code'] ?>"><?php echo $rows['tour_code']?></option>
                    <?php
                    }
                    ?>
                </select>
            </div>
            <div class="tourupdate">
